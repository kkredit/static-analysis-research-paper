...
\paragraph{Analyze as you develop} As already established, considering security late in the
...
for the sake of backwards compatibility. To prevent its use in new code, static analysis tools can
detect such usage.

\paragraph{Identify dangerous syntax idioms} Blah blah.

\paragraph{Apply rigorous logical analysis} Blah blah.

\paragraph{Interact with the human-computer interface} Blah blah.

\subsection{Limitations}

Analyzing source alone also entails limitations.

\paragraph{No functional testing} Blah blah.

\paragraph{No compiler validation} Blah blah.

\paragraph{No higher order logic validation} Blah blah.
